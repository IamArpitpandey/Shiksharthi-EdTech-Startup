...
const Tag = ({ children, active = false, onClick }) => (
  <button onClick={onClick} className={`text-sm px-3 py-1 rounded-full border ${active ? 'bg-amber-600 text-white border-amber-600' : 'bg-white text-amber-700 border-amber-100'} shadow-sm`}>{children}</button>
);
    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          <div className="bg-gradient-to-br from-amber-50 to-pink-50 rounded-3xl p-8 shadow-xl border border-amber-100">
            <div className="flex flex-col lg:flex-row gap-6 items-start">
              <div className="flex-1">
                <h1 className="text-3xl font-extrabold text-amber-800">Explore the Library — visually rich and curated</h1>
                <p className="mt-3 text-amber-700">A magazine-style collection of study guides, videos and interactive resources to help you revise faster.</p>

                <div className="mt-5 flex gap-3">
                  <Link to="/library/featured" className="bg-amber-600 text-white px-4 py-2 rounded-lg">Featured</Link>
                  <Link to="/library/new" className="border border-amber-600 text-amber-700 px-4 py-2 rounded-lg">New Arrivals</Link>
                </div>
              </div>
              ...
              <div className="w-full lg:w-64">
                <div className="bg-white p-4 rounded-xl shadow-inner">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="text-amber-500"><FaSearch /></div>
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="bg-white p-4 rounded-xl shadow-md">
            ...
            <ul className="mt-3 space-y-2 text-sm text-gray-600">
              <li className="flex justify-between"><span>Physics Quick Labs</span> <span className="text-amber-500">Views</span></li>
              <li className="flex justify-between"><span>Genetics: Mendel’s Laws</span> <span className="text-amber-500">Downloads</span></li>
              <li className="flex justify-between"><span>Past Exam Paper: 2019</span> <span className="text-amber-500">Attempts</span></li>
            </ul>
          </div>
